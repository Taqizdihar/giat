  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await axios.post("/api/messages", {
        ...
        sender_email: formData.sender_email || "N/A", // From wa number mapping if needed
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <motion.div
              ...
              className="bg-background p-8 rounded-[32px] shadow-sm border border-border"
            >
              <h3 className="text-2xl font-bold mb-8">Informasi Kontak</h3>
              <ul className="space-y-8">
                <li className="flex gap-4 items-start">
                  <div className="w-12 h-12 bg-giat-red/10 rounded-2xl flex items-center justify-center shrink-0">
                    <MapPin className="w-6 h-6 text-giat-red" />
                  </div>
                  <div>
                    <h4 className="font-bold text-lg mb-1">Alamat Lengkap</h4>
                    <p className="text-muted-foreground">
                      {content.address || "Gedung lt.1, Jln. Telekomunikasi No 1 Terusan Buah Batu Bandung, Bandung 40257."}
                    </p>
                  </div>
                </li>
                <li className="flex gap-4 items-start">
                  <div className="w-12 h-12 bg-giat-blue/10 rounded-2xl flex items-center justify-center shrink-0">
                    <Clock className="w-6 h-6 text-giat-blue dark:text-blue-400" />
                  </div>
                  <div>
                    <h4 className="font-bold text-lg mb-1">Jam Operasional</h4>
                    <p className="text-muted-foreground">{content.operational_hours || "Senin - Jumat (08.00 - 16.30 WIB)"}</p>
                  </div>
                </li>
                <li className="flex gap-4 items-start">
                  <div className="w-12 h-12 bg-giat-red/10 rounded-2xl flex items-center justify-center shrink-0">
                    <Phone className="w-6 h-6 text-giat-red" />
                  </div>
                  <div>
                    <h4 className="font-bold text-lg mb-1">Telepon</h4>
                    <p className="text-muted-foreground">{content.phone || "+62 812-XXXX-XXXX"}</p>
                  </div>
                </li>
                <li className="flex gap-4 items-start">
                  <div className="w-12 h-12 bg-giat-blue/10 rounded-2xl flex items-center justify-center shrink-0">
                    <Mail className="w-6 h-6 text-giat-blue dark:text-blue-400" />
                  </div>
                  <div>
                    <h4 className="font-bold text-lg mb-1">Email</h4>
                    <p className="text-muted-foreground">{content.email || "giat@koperasi.com"}</p>
                  </div>
                </li>
              </ul>
              ...
              <div className="mt-10 pt-8 border-t border-border">
                ...
                <div className="flex gap-4">
                  <a 
                    ...
                    className="w-12 h-12 rounded-full bg-muted flex items-center justify-center hover:bg-giat-red hover:text-white transition-all"
                  >
                    <Instagram className="w-6 h-6" />
                  </a>
                  <a 
                    href={content.link_shopee || "https://id.shp.ee/1uN1AdKC"} 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="w-12 h-12 rounded-full bg-muted flex items-center justify-center hover:bg-giat-blue hover:text-white transition-all"
                  >
            ...
            >
              ...
              <div className="bg-muted/30 rounded-[32px] overflow-hidden h-[300px] relative border border-border">
                ...
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.307454341908!2d107.62949671537544!3d-6.973006994962295!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e9adf177bf8d%3A0x437398556f9fa03!2sTelkom%20University!5e0!3m2!1sen!2sid!4v1625000000000!5m2!1sen!2sid" 
                  width="100%" 
                  height="100%" 
                  style={{ border: 0, position: 'absolute', inset: 0 }} 
                  loading="lazy"
                  title="Lokasi GIAT"
                  className="opacity-80 hover:opacity-100 transition-opacity duration-500 relative z-10"
                ></iframe>
              </div>
            </motion.div>
          </div>
