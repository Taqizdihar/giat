      ...
      <section className="py-24 bg-muted/30 min-h-[calc(100vh-80px)]">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            >
              Koperasi Giat Sejahtera Bersama (GIAT) lebih dari sekadar toko. 
              Kami adalah koperasi yang berpusat pada mahasiswa, berdedikasi untuk menyediakan 
              kebutuhan berkualitas dan menumbuhkan jiwa kewirausahaan di Telkom University.
            </motion.p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-4">Sejarah Kami</h3>
              <p className="text-muted-foreground leading-relaxed">
