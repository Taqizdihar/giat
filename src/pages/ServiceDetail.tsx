...
export function ServiceDetail() {
  ...
  useEffect(() => {
    ...
    axios.get("/api/services").then(res => {
      const service = res.data.find((s: any) => s.id.toString() === id);
      if (service) {
        const iconMap: any = {
          'Wallet': Wallet,
          'PiggyBank': PiggyBank,
  ...
  if (loading) {
    return <div className="pt-32 pb-24 text-center">Memuat detail layanan...</div>;
  }
    ...
    <div className="pt-20 bg-slate-50 dark:bg-slate-950 min-h-screen pb-24">
      <div className="container mx-auto px-6 py-12">
        ...
        >
          <Button 
            variant="ghost" 
            className="mb-8 text-giat-blue dark:text-blue-400 hover:text-giat-red dark:hover:text-red-400 hover:bg-transparent px-0 flex items-center gap-2"
            onClick={() => navigate(-1)}
          >
          ...
          <div className="grid lg:grid-cols-3 gap-12 items-start">
            ...
            <div className="lg:col-span-2 space-y-10">
              <div>
                ...
                <h1 className="text-3xl md:text-4xl font-bold text-giat-blue dark:text-blue-400 mb-4">
                  {activeService.title}
                </h1>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-2 text-giat-blue dark:text-blue-400 font-bold text-xl mb-4">
                  <CheckCircle2 className="w-6 h-6 text-giat-red" />
                  Manfaat Utama
                </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-2 text-giat-blue dark:text-blue-400 font-bold text-xl mb-4">
                  <FileText className="w-6 h-6 text-giat-red" />
                  Syarat Pengajuan
                </div>
